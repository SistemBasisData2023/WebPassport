...
public class FileQuery {
    ...
    public static final String FIND_ALL_NO_DATA = "SELECT files_id, content_type, 0 AS data, name, size FROM Files";
    public static final String FIND_BY_ID_NO_DATA = "SELECT files_id, content_type, 0 AS data, name, size " +
            "FROM Files WHERE files_id = ?::uuid";
